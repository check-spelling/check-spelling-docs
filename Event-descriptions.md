...
- [summary-tables-error](#summary-tables-error)
  - [Resolution](#summary-tables-error-r)
- [slow-file](#slow-file)
...
Perl 5 didn't like the regular expression.

The log should actually provide a more detailed message from Perl.

You can test your pattern with [Regular Expression Test Page for Perl](https://www.regexplanet.com/advanced/perl/).

The tool generally doesn't apply flags that significantly modify evaluation (it might apply `/g`).

## <a id="bad-regex-r"></a>Resolution

* If the pattern is in `patterns.txt`, `candidate.patterns`, or `line_forbidden.patterns`, then correct the pattern. If the pattern was copied from another source, please report the error to that source.
* Otherwise, if the pattern appears to be generated by check-spelling itself, please review [`bad-regex` issues in check-spelling](https://github.com/check-spelling/check-spelling/issues?q=is%3Aissue%20bad-regex) and if you don't find a match, open one.
...
Please [review the list of known 🐛 bugs](https://github.com/check-spelling/check-spelling/issues?q=is%3Aissue%20%22summary-tables-error%22) and if you cannot find one that matches this case, please [file a 🐛 bug](https://github.com/check-spelling/check-spelling/issues/new?title=%5Bsummary-tables-error%5D%20scenario&body=Please%20provide%20details+preferably%20including%20a%20link%20to%20a%20workflow%20run,%20the%20configuration%20of%20the%20repository,%20and%20anything%20else%20you%20may%20know%20about%20the%20problem%2e).
...
Reruns of a check-spelling job for a merged PR (prior to [v0.0.26](https://github.com/check-spelling/check-spelling/releases/tag/v0.0.26)) will not work as GitHub will never recreate the merge head for a merged PR. You can create a new PR.
...
Prior to [0.0.27](https://github.com/check-spelling/check-spelling/releases/tag/v0.0.27), [only_check_changed_files](Configuration#onlycheckchangedfiles) would trigger this message.
