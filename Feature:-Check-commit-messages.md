...
* listed in details by their own distinct events ([`unrecognized-spelling-commit-message`](Event-descriptions#unrecognized-spelling-commit-message) / [`unrecognized-spelling-pr-description`](Event-descriptions#unrecognized-spelling-pr-description) / [`unrecognized-spelling-pr-title`](Event-descriptions#unrecognized-spelling-pr-title))
