...
If you have [duplicate detection](Feature%3A-Forbidden-patterns.md#duplicate-words), you may run into false positives, here are some examples of ways to suppress them:
